...
export const getSimplePlotData = () => {
    let visits = 10;
    return range(366)
...
export const getGanttPlotData = () => {
    let ColorSet;
    if (!isServer) {
        ColorSet = require('@amcharts/amcharts4/core').ColorSet;
    }
...
export const SCATTER_PLOT_DATA: PlotParams['data'] = [
    {
        x: [1, 2, 3],
        y: [2, 6, 3],
        type: 'scatter',
